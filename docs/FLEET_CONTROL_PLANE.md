...
P7 collector, 권위 inventory issuer, 증적 원장, cleanup executor는 2026-09-12에 제거했다.
인벤토리는 발급까지 끝나 결과물을 얻었고, 장치가 요구하는 수작업이 원래 목적과 어긋났다.
저장소별 legacy 운영 JSON 정리는 남아 있는 작업이지만 평범한 PR로 진행한다.
