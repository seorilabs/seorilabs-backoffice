...
import { agentGithubMutationReadbackSchema } from "@/lib/control-plane/contracts";
import { recordGithubMutationReadback } from "@/lib/control-plane/agent-mutation-service";
...
const ROUTE = "/api/internal/agent-adapter/github-mutations/readback";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const body = agentGithubMutationReadbackSchema.parse(rawBody);
