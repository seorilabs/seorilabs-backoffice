...
import { agentGithubMutationRecoveryClaimSchema } from "@/lib/control-plane/contracts";
import { claimGithubMutationRecovery } from "@/lib/control-plane/agent-mutation-service";
...
const ROUTE = "/api/internal/agent-adapter/github-mutations/recovery";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const body = agentGithubMutationRecoveryClaimSchema.parse(rawBody);
