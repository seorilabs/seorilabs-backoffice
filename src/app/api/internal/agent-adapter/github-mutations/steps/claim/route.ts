...
import { agentGithubMutationStepClaimSchema } from "@/lib/control-plane/contracts";
import { claimGithubMutationStep } from "@/lib/control-plane/agent-mutation-service";
...
const ROUTE = "/api/internal/agent-adapter/github-mutations/steps/claim";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const body = agentGithubMutationStepClaimSchema.parse(rawBody);
    ...
    const step = await claimGithubMutationStep({
      ...body,
