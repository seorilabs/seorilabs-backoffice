...
import { agentGithubMutationStepPlanSchema } from "@/lib/control-plane/contracts";
import { planGithubCommitMutationStep } from "@/lib/control-plane/agent-mutation-service";
...
const ROUTE = "/api/internal/agent-adapter/github-mutations/steps/plan";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const body = agentGithubMutationStepPlanSchema.parse(rawBody);
    ...
    const plan = await planGithubCommitMutationStep({
      ...body,
