...
import { agentGithubMutationStepCompleteSchema } from "@/lib/control-plane/contracts";
import { completeGithubMutationStep } from "@/lib/control-plane/agent-mutation-service";
...
const ROUTE = "/api/internal/agent-adapter/github-mutations/steps/complete";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const body = agentGithubMutationStepCompleteSchema.parse(rawBody);
    ...
    const completion = await completeGithubMutationStep({
      ...body,
